...
# Lee los hosts permitidos del .env. Si no hay, usa un valor seguro por defecto para local.
allowed_hosts_env = os.environ.get('ALLOWED_HOSTS', '127.0.0.1,localhost')
ALLOWED_HOSTS = allowed_hosts_env.split(',')

# Actualiza tus orígenes de confianza a tu nuevo dominio de Cloudflare
